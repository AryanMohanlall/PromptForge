...
namespace ABPGroup.Migrations
{
    ...
    [Migration("20260319183849_UserFavoriteTemplates")]
    partial class UserFavoriteTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABPGroup.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABPGroup.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ABPGroup.Templates.Template", b =>
                {
                    ...
                    b.Property<string>("ScaffoldConfig")
            ...
            modelBuilder.Entity("ABPGroup.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("ABPGroup.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("ABPGroup.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ABPGroup.Authorization.Users.User", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
